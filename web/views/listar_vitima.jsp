<%@page import="ModelDAO.VitimaDAO"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="Model.Vitima"%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">Todas as Vitimas</h4>
                                ...
                                VitimaDAO dao= new VitimaDAO();
                                List<Vitima> list = dao.listar();
                                Iterator<Vitima> iter = list.iterator();
                               Vitima vitima = null;
                                while (iter.hasNext()) {
                                    vitima = iter.next();
                                        ...
                                        <tbody>
                                            <tr>
                                               <td><%=vitima.getNome()%></td>
                                                <td><%=vitima.getEstado()%></td>
                                                <td><%=vitima.getDataNascimento()%></td>
                                                <td><%=vitima.getBI()%></td>
                                                <td><%=vitima.getGenero()%></td>
                                                <td>aaaaaaaa</td>
                                            </tr>
                                          <%}%>
