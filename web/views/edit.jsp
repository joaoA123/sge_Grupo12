<%-- 
    Document   : edit
    Created on : 05/01/2019, 19:33:23
    Author     : USER
--%>
        ...
        %>
            <div class="container">
              <div class="card card-register mx-auto mt-5">
                <div class="card-body">
                    <div class="col-lg-12">
                 <h1>Editar Dados do Arquivo</h1>
        <form action="Controller" method="post">
            <div>
                 <label>Actualizar Nome</label><br>
                 <input class="form-control" type="text" name="nome" placeholder="Informe o nome" value="<%= ut.getNome()%>" required=""/><br>
            </div>
            <div>
            <label>Actualizar Preco</label><br>
            <input class="form-control" type="number" name="preco" placeholder="Informe o novo Preço" value="<%= ut.getPreco()%>" required=""/><br>
            </div>
