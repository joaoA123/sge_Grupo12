<%-- 
    Document   : listarP
    Created on : 13/mar/2019, 14:06:07
    Author     : ELVIS JR
--%>

<%@page import="ModelDAO.PropietarioDAO"%>
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ETAPA 1</li>
                        ...
                        <a class="btn btn-success" href="Controller?action=add">Adicionar Um Arquivo</a>
                        ...
                        <table class="table table-bordered table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nº ARQUIVOS</th>
                                    <th class="text-center">ULTIMO UPLOAD</th>
                                    <th class="text-center">N DE VENDA</th>
                            ...
                            <%
                                ...
                                List<Propietario> list = dao.listar();
                                Iterator<Propietario> iter = list.iterator();
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center"><%= prop.getId()%></td>
                                    <td class="text-center"><%= prop.getNome()%></td>
                                    <td class="text-center"><%= prop.getEmail()%></td>
                                    <td class="text-center"><%= prop.getSenha()%></td>
                                  
                                    <td class="text-center">
                                        <a class="btn btn-warning" href="Controller?action=editar&id=<%= prop.getId()%>">Editar</a>
                                        <a class="btn btn-danger" href="Controller?action=apagar&id=<%= prop.getId()%>">Remover</a>
                                    </td>
                                </tr>
                                <%}%>
                            </tbody>
