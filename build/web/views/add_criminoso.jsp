            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">CADASTRO DE CRIMINOSO</h4>
                                    ...
                                    <form method="post"   action="Controller" class="forms-sample"  >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="dataNascimento" class="form-control" id="exampleInputEmail3" placeholder="Email">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">Apelido (Nome Conhecido no bairro) </label>
                                            <input type="text" class="form-control" name="apelido" id="exampleInputName1" placeholder="Apelido">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Bairro</label>
                                            <select class="form-control" name="bairro" id="exampleSelectGender">
                                                <option value="Masculino">GOlf2</option>
                                                <option value="Femenino">Mayanga</option>
                                            </select>
                                        </div>
                                           <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-xs-12">
                                                <input type="file" class="form-control file-upload-info" name="imge"  placeholder="Upload Image">
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2" name="action" value="cadastro_criminoso">Cadastrar</button>
