            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">CADASTRO DE CRIME</h4>
                                    <form method="post" action="Controller" class="forms-sample" >
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Bairro</label>
                                            <select class="form-control" name="bairro_crime" id="exampleSelectGender">
                                                <option value="Golf2">GOlf2</option>
                                                <option value="Mayanga">Mayanga</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Tipo de Crime</label>
                                            <select class="form-control" name="tipo_crime" id="exampleSelectGender">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="data" class="form-control" id="exampleInputName1" placeholder="Nome Completo">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Hora</label>
                                            <input type="time" class="form-control" name="hora_crime" id="exampleInputEmail3" placeholder="Email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleTextarea1">Descrição</label>
                                            <textarea class="form-control" name="descricao_crime" id="exampleTextarea1" rows="4"></textarea>
                                        </div>
                                        
                                        <button type="submit" class="btn btn-primary mr-2" name="action" value="cadastro_crime">Cadastrar</button>
