<%-- 
    Document   : add
    Created on : 05/01/2019, 19:33:15
    Author     : USER
--%>
      ...
      <form method="post"  action="Controller">
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="tipo" name="tipo" type="text" aria-describedby="emailHelp" placeholder="Tipo Obrigatorio">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="preco" name="preco" type="number" aria-describedby="emailHelp" placeholder="Informe o preço" required="Campo Obrigatorio">
          </div>

          <input type="hidden" name="idprop" value="<%=idprop%>"/>
            <input class="btn btn-primary " name="action" type="submit" value="Seguinte"/>
          </div>
      </div>
